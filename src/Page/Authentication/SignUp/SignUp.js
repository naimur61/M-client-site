            ...
            <div className="card md:w-6/12 bg-base-100 shadow-xl mx-auto">
               <div className="card-body">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                     ...
                     <input type='text' placeholder="University Name" {...register("university", { required: true })} className="input input-bordered w-full  block  mb-2" />
                     {/* errors will return when field validation fails  */}
                     ...
                     <input type='text' placeholder="Address" {...register("address", { required: true })} className="input input-bordered w-full  block  mb-2" />
                     {/* errors will return when field validation fails  */}
